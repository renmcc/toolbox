...
import "github.com/renmcc/toolbox/pb/page/page.proto";
import "github.com/renmcc/toolbox/pb/request/request.proto";
...
message QueryBookRequest {
    // 分页参数
    // @gotags: json:"page" 
    renmcc.toolbox.page.PageRequest page = 1;
    // 关键字参数
...
message UpdateBookRequest {
    ...
    renmcc.toolbox.request.UpdateMode update_mode = 2;
    // 更新人
